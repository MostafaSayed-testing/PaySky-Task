...
public class UserCreationTest {
    ...
    public void createUserTest() {
        ...
        requestData.put("name", "Mostafa");
        requestData.put("job", "Mid-Senior Software Tester");
        ...
        Assert.assertEquals(name, "Mostafa", "Name does not match");
        Assert.assertEquals(job, "Mid-Senior Software Tester", "Job does not match");
    }
}
